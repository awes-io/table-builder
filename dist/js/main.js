                ...
                _c("thead", [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.hiddenOptions && _vm.hiddenOptions.length
                        ? _c("th")
                        : _vm._e()
                    ],
                    2
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._t(
                                      ...
                                      {
                                        data: rowData,
                                        hiddenData: _vm.hiddenColumnData[i],
                                        matchedMedia: _vm.matchedMedia,
                                        index: i
                                      }
                                    )
                            ...
                            return [
                              p
                                ? _c(
                                    ...
                                    {
                                      key: i,
                                      staticClass: "btn has-wave",
                                      class: {
                                        active: p === _vm.meta.current_page
                                      },
                                      attrs: { href: _vm.getStringified(p) },
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault();
                                          _vm.setPage(p);
                                ...
                                : _c(
                                    "span",
                                    { key: i, staticClass: "btn-group__separator" },
                                    [_vm._v("...")]
                                  )
                            ]
                          })
